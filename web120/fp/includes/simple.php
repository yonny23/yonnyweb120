...
?>
	...
	<div>
		<label>
			What dish would you recommend us serving?:<br /><input type="text" name="Name" required="required" placeholder="An adequate is required pl0x" title="Name is required" tabindex="10" size="44" autofocus />
		</label>
	</div>
	<div>	
		<label>
			What do you want us to do better?:<br /><input type="email" name="Email" required="required" placeholder="You can lie here" title="A valid email is required" tabindex="20" size="44" />
		</label>
	</div>
	<!-- below change the HTML to your form elements - only 'Name' & 'Email' (above) are significant -->
	<div>	
		<label>
			Comments:<br /><textarea name="Comments" cols="36" rows="4" placeholder="Your comments are important to us!(not really but we will say they are)" tabindex="30"></textarea>
		</label>
	</div>	
	<div><?=$feedback?></div>
